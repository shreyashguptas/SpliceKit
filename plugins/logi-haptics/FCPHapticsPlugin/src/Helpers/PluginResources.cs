namespace Loupedeck.FCPHapticsPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.FCPHapticsPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.FCPHapticsPlugin.Resources.Resource.txt`.
